...
class ResourceConfig:
    ...
    def __init__(self):
        ...
        self.next_generation_model_dirname_tmpl = "{0}_model_{1}"
...
def create_uci_labels():
    ...
    for l1 in range(8):
        l = letters[l1]
        for p in promoted_to: # 'pure' promotions
            labels_array.append(l + '2' + l + '1' + p)
            labels_array.append(l + '7' + l + '8' + p)
            if l1 > 0: # 'promotions after capturing'
                l_l = letters[l1 - 1]
                labels_array.append(l + '2' + l_l + '1' + p)
                labels_array.append(l + '7' + l_l + '8' + p)
            if l1 < 7: # 'promotions after capturing'
                l_r = letters[l1 + 1]
